...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'Simstock_QGIS_dialog_base.ui'))


class SimstockQGISDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(SimstockQGISDialog, self).__init__(parent)
